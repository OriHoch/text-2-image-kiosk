...
with open("/home/ubuntu/sd-api-config.json", "r") as f:
...
class ConfigArgumentParser:
    ...
    def add_argument(self, name, default=None, **kwargs):
        ...
        setattr(self, name, self._values.get(name, default))


def main(config_values=None):
    opt = parser = ConfigArgumentParser(config_values)
